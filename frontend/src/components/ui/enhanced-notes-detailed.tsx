        ...
        <div className="space-y-4 p-4 bg-muted/50 rounded-lg">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <div className="text-xs font-medium text-muted-foreground">Guided Questions</div>
              <Button
                type="button"
                variant="ghost"
                size="sm"
                onClick={() => setShowPromptFields(!showPromptFields)}
                className="h-6 px-2 text-xs"
              >
                {showPromptFields ? "Hide" : "Show"} Input Fields
              </Button>
            </div>
